...
class CartPoleSwingUpEnv(gym.Env):
    ...
    def reset(self):
        ...
        self.state = np.random.normal(loc=np.array([0.0, 0.0, 0.0, 0.0]), scale=np.array([0.2, 0.2, 0.2, 0.2]))
