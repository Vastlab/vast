...
class objecto_center_loss(tensor_center_loss):
    def __init__(self, beta=0.1, classes=range(10), fc_layer_dimension=2, ring_size=50, initial_value=None, unknowns_label=-1):
        super().__init__(beta=beta, classes=classes, fc_layer_dimension=fc_layer_dimension, initial_value=initial_value)
